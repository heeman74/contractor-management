...
- [ ] 31-02-PLAN.md — Backend: receipt upload/list/delete + cost-receipts serve_router branch (RLS-scoped), receipt E2E (Wave 2)
- [ ] 31-03-PLAN.md — Web: finance feature module (API/hooks/components) + Costs sections on job/trade-scope/project detail, permission-gated, Playwright + Jest (Wave 3)
...
| 31. Actual Cost Capture | v4.0 | 1/5 | In Progress|  |
