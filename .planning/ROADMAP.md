...
Plans:
- [ ] 23-01-PLAN.md — Backend foundation: migration 0020 (4 chat tables with RLS), SQLAlchemy models, repository, service, schemas, WebSocket ConnectionManager with Redis pub/sub
- [ ] 23-02-PLAN.md — Mobile data layer: Drift schema v11 (3 chat tables), ChatDao, ChatWsClient with reconnect backoff, ChatSyncService (offline outbox), Riverpod providers
...
| 23. Real-Time Chat | v3.0 | 0/6 | Planning complete | - |
