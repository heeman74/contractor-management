...
Plans:
- [ ] 22-01-PLAN.md — Backend: migration 0019 (task_notes table + annotation_data JSONB), TaskNote model/service/schemas, task note + attachment upload endpoints, integration tests
...
| 22. Task Execution and Photo Annotation | v3.0 | 0/5 | Planned | - |
