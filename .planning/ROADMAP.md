...
- [x] 34-02-PLAN.md — Budget CRUD endpoints + single spend definition + additive budget-vs-actual block on breakdown/rollup responses
...
- [x] 36-03-PLAN.md — DB-free profitability_math: D-01 eligibility, the three D-03 signals, severity bands, fingerprint
- [x] 36-04-PLAN.md — ProfitabilityFindingCard + drill-down mount + jest state matrix
- [x] 36-05-PLAN.md — Reusable ai_grounding validator, call_claude_json_strict, the D-09 prompt contract
...
- [x] 37-07-PLAN.md — Bounded comparable query, the rate reduction, and the closed-set payload [wave 4]
- [x] 37-08-PLAN.md — FinanceGate fallback + the quote-detail variance card behind the layered double lock [wave 4]
...
| 37. AI Quote Planning | v4.0 | 8/12 | In Progress|  |
