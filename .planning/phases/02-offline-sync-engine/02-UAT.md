...
result: issue
reported: "GET /api/v1/sync?cursor= returns 422 validation error: 'Input should be a valid datetime or date, input is too short'. Empty cursor string is not handled — should default to epoch for full first-launch download."
severity: major
...
result: issue
reported: "No response with clicking login buttons."
severity: blocker
...
result: skipped
reason: Login blocker — cannot reach app screens
