...
| D-09 | `alert_summary` ≤280 chars enforced; over-length rejected, never silently truncated | integration | `pytest tests/test_phase_36_e2e.py::test_alert_summary_length_contract -x` | 36-08 T2 | ⬜ created by that task |
